...
export default function LineChart7() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <Card className="w-full rounded-3xl lg:max-w-lg bg-linear-to-br from-slate-900 via-slate-900 to-emerald-950/90 border-slate-700 text-white shadow-2xl shadow-emerald-500/10">
