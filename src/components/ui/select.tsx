    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          ...
          position === "popper" &&
            "data-[side=left]:-translate-x-1 data-[side=top]:-translate-y-1 w-full min-w-(--radix-select-trigger-width) data-[side=right]:translate-x-1 data-[side=bottom]:translate-y-1",
          className,
        )}
