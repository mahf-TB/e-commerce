...
function DropdownMenuContent({
  ...
  onCloseAutoFocus,
  // swallow setOpen if accidentally passed so it doesn't end up on DOM
  setOpen: _setOpen,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Content> & { setOpen?: unknown }) {
...
function DropdownMenuItem({
  ...
  inset,
  variant = "default",
  // swallow setOpen to avoid unknown DOM attribute if present
  setOpen: _setOpen,
  ...props
...
function DropdownMenuLabel({
  className,
  inset,
  // swallow setOpen to prevent it being forwarded to DOM
  setOpen: _setOpen,
  ...props
...
function DropdownMenuSeparator({
  className,
  // swallow setOpen if present
  setOpen: _setOpen,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Separator> & { setOpen?: unknown }) {
  return (
